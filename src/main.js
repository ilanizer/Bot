...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['ud3387fb69f3a66d03cf521df89b20540'];
        return bot; ud3387fb69f3a66d03cf521df89b20540
    }
    ...
    poll(operation) {
        ...
        if(operation.type == 19) { //ada kick
            // op1 =  ['uaf57a04b8abca47760eb49da8db18d14'];
            // op2 = yang 'nge' kick
            // op3 = yang 'di' kick
    ...
    async textMessage(messages) {
        ...
        this.command('Halo', ['Aku gila','Kamu ?']);
        this.command('ngantuk', ['Molor Om','zzz']);
        ...
        this.command('tae', this.getSpeed.bind(this));
